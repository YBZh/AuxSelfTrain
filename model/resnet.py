...
class ResNet(nn.Module):
    def __init__(self, block, layers, bottle_neck=False):
        self.inplanes = 64
        ...
        if self.bottle_neck:
            self.bottle_fc = nn.Linear(512 * block.expansion, 512)
...
def resnet18(bottle_neck = False, pretrained=True):
    """Constructs a ResNet-18 model.
    Args:
      pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], bottle_neck)
    if pretrained:
...
def resnet34(bottle_neck = False, pretrained=True):
    """Constructs a ResNet-34 model.
    Args:
      pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], bottle_neck)
    if pretrained:
...
def resnet50(bottle_neck = False, pretrained=True):
    """Constructs a ResNet-50 model.
    Args:
      pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], bottle_neck)
    if pretrained:
